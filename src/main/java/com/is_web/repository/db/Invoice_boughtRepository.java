...
import com.is_web.entities.Invoice_bought;
...
public class Invoice_boughtRepository extends DatabaseRepository<Invoice_bought> {

    @Override
    protected Invoice_bought createEntity(ResultSet resultSet) throws SQLException {
        Invoice_bought entity = new Invoice_bought();
    ...
    protected String getTableName() {
        return "dbo.invoices_bought";
    }

    @Override
    protected PreparedStatement createInsertStatement(Invoice_bought entity) throws SQLException {
    ...
    @Override
    protected PreparedStatement createUpdateStatement(Invoice_bought entity) throws SQLException {
        java.sql.Connection connection = Connection.getInstance().getConnection();
        PreparedStatement statement = connection.prepareStatement(
    ...
    @Override
    public void execTransactionCreateNewEmployee(Invoice_bought newEmployee) throws SQLException {
    }

    @Override
    public void execTransactionUpdateEmployee(Invoice_bought newEmployee) throws SQLException {
    }
    ...
    @Override
    public void execTransactionCreateNewLocality(Invoice_bought newEmployee) throws SQLException {
    }
}